...
/**
 * TEST WITH PARAMETERS AS CONSTRUCTOR
 * Aiken record types compile to Constructor(tag, [fields])
 */

import { Lucid, Blockfrost, Data, applyParamsToScript, getAddressDetails, validatorToAddress, Constr } from "@lucid-evolution/lucid";
...
console.log("═══════════════════════════════════════════════════════");
console.log("🧪 TEST WITH PARAMETERS AS CONSTRUCTOR");
console.log("═══════════════════════════════════════════════════════\n");
...
try {
    ...
    console.log("🔧 Applying parameters as Constr(0, [...])...");
    console.log(`   beacon_policy: ${BEACON_POLICY_ID}`);
    console.log(`   admin_key_hash: ${adminKeyHash}\n`);

    // Record types in Aiken compile to Constructor with tag 0
    const params = new Constr(0, [
    ...
    console.log("═══════════════════════════════════════════════════════");
    console.log("✅ ✅ ✅ CONSTR PARAMS WORK! ✅ ✅ ✅");
    console.log("═══════════════════════════════════════════════════════\n");
