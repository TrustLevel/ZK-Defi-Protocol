 ...
 * Pass fields as separate array elements, not as single object
 */
...
console.log("═══════════════════════════════════════════════════════");
console.log("🧪 TEST WITH FLATTENED PARAMETERS");
console.log("═══════════════════════════════════════════════════════\n");
...
try {
    ...
    console.log("🔧 Applying FLATTENED parameters...");
    console.log(`   beacon_policy: ${BEACON_POLICY_ID}`);
    console.log(`   admin_key_hash: ${adminKeyHash}\n`);

    // CRITICAL FIX: Pass fields as SEPARATE array elements (flattened)
    const parameterizedScript = applyParamsToScript(validator.compiledCode, [
        BEACON_POLICY_ID,  // First field: beacon_policy
        adminKeyHash,      // Second field: admin_key_hash
    ]);
    ...
    console.log("═══════════════════════════════════════════════════════");
    console.log("✅ ✅ ✅ FLATTENED PARAMS WORK! ✅ ✅ ✅");
    console.log("═══════════════════════════════════════════════════════\n");
