 ...
 * Read-only refs only. Output: receipts/vkey.json { txHash, borrowIdx, settlementIdx }.
 */
import {
  loadEnv, makeProvider, makeWallet, walletAddress, makeTxBuilder,
  buildVkeyDatum, BORROW_VKEY, SETTLEMENT_VKEY, ALWAYS_FALSE_ADDRESS, saveReceipt, scanLink,
} from "./common.mjs";
...
const receipt = { txHash, borrowIdx: 0, settlementIdx: 1, address: ALWAYS_FALSE_ADDRESS };
console.log("Both VKeys parked. txHash:", txHash, "| borrow #0, settlement #1");
